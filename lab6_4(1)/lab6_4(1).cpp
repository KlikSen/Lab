...
int main()
{
    ...
    cout << "Кількість чисел = "; cin >> n;
    cout << "Мінімальне значення = "; cin >> a;
    cout << "Максимальне значення = "; cin >> b;
    ...
    cout << "Максимальний елемент масиву = "  <<Max(mas, N)<< endl;
    cout << "Сумa елементів масиву = " << Sum(mas, OstanDod(mas, N)) << endl;
